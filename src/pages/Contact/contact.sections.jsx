// === Xingzhu Technology - Contact Page Sections ===
...
import { FORM_FIELDS, CONTACT_METHODS, FAQ_ITEMS, OFFICE_LOCATIONS } from './contact.data'
...
function InfoPanel() {
  return (
    ...
    >
      {/* Contact methods */}
      <div>
        <h3 className="text-white text-lg font-semibold mb-5">联系方式</h3>
      ...
      {/* FAQ */}
      <div>
        <h3 className="text-white text-lg font-semibold mb-5">常见问题</h3>
        <FaqAccordion items={FAQ_ITEMS} />
      </div>

      {/* Office locations */}
      <div>
        <h3 className="text-white text-lg font-semibold mb-5">办公地址</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-12 lg:gap-16">
        ...
        <div>
          <SectionHeader
            eyebrow="联系我们"
            headline="开启智能升级之旅"
            description="填写以下信息，我们的解决方案专家将为您提供一对一的咨询服务。"
          />
      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight text-white leading-[1.1]">
            与星筑科技
            <br />
            <span className="text-accent-500">建立联系</span>
          </h1>
...
export { HeroSection, ContactFormSection }
