...
export default function CTASection() {
  return (
    <section className="relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-r from-surface-100 via-surface-200 to-surface-100" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 py-24 md:py-32">
        ...
        >
          <motion.h2
            ...
            className="text-3xl md:text-4xl lg:text-5xl font-bold text-surface-800 tracking-tight"
          >
            {CTA_DATA.title}
          </motion.h2>
          <motion.p
            variants={ctaContentVariants}
            className="text-lg text-surface-500 leading-relaxed max-w-lg"
          >
